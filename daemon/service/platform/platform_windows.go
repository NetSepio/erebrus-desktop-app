...
func doInitConstants() {
	...
	logFile = path.Join(installDir, "log/Erebrus Agent.log")
...
func doOsInit() (warnings []string, errors []error, logInfo []string) {
	...
	wgConfigFilePath = path.Join(settingsDir, "Erebrus.conf") // will be used also for WireGuard service name (e.g. "WireGuardTunnel$Erebrus")
