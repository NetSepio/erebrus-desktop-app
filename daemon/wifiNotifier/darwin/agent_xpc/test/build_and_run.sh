...
clean() {
  echo "Cleaning up..."
  sudo launchctl unload -w /Library/LaunchDaemons/erebrus.xpc.test.service.plist || echo "No service to unload"
  sudo rm /Library/LaunchDaemons/erebrus.xpc.test.service.plist /tmp/xpc_server || echo "No files to remove"
...
# Load daemon
sudo cp erebrus.xpc.test.service.plist /Library/LaunchDaemons
sudo launchctl load -w /Library/LaunchDaemons/erebrus.xpc.test.service.plist || error '"launchctl load" failed'
