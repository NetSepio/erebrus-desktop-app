...
//
#define DEVICE_NAME_PUBLIC L"\\\\.\\EREBRUSSPLITTUNNEL"

//
// Driver registration params
//
#define DRV_DEVICE_NAME_STRING      L"\\Device\\EREBRUSSPLITTUNNEL"
#define DRV_SYMBOLIC_NAME_STRING    L"\\Global??\\EREBRUSSPLITTUNNEL"
//
