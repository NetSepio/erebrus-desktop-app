#include "erebrusSplitTunDrvControl.h"

#define EREBRUS_ST_SERVICE_NAME L"erebrus-split-tunnel"
#define EREBRUS_ST_SERVICE_DISPLAY_NAME L"Erebrus Split-Tunnel Service"
...
namespace splittun
{
	...
	bool StartDriverAsService(LPCTSTR serviceExe)
	{
		...
		SC_HANDLE schService = CreateService(
			...
			EREBRUS_ST_SERVICE_NAME,    // address of name of service to start
			EREBRUS_ST_SERVICE_DISPLAY_NAME,    // address of display name
	...
	bool StopDriverAsService()
	{
		...
		SC_HANDLE schService = OpenService(
			schSCManager,
			EREBRUS_ST_SERVICE_NAME,	// Service name
			SERVICE_ALL_ACCESS
		);
