...
DESKTOP_SRC_FILE=/opt/erebrus/ui/Erebrus.desktop
ICON_SRC_FILE=/opt/erebrus/ui/erebrusicon.svg
sudo chmod 744 $DESKTOP_SRC_FILE
sudo chmod 744 $ICON_SRC_FILE

# create link to .desktop file
APPS_DIR=/usr/share/applications
DESKTOP_APPS_FILE=$APPS_DIR/Erebrus.desktop
if [ -d "$APPS_DIR" ]; then
...
sudo chmod 4755 /opt/erebrus/ui/bin/chrome-sandbox || echo "[!] Failed to 'chmod' for '/opt/erebrus/ui/bin/chrome-sandbox'"