...
_pub_key_file="/Applications/Erebrus.app/Contents/Resources/public.pem"

_volume=""

_app_path="/Applications/Erebrus.app"
...
{
    return `ps -eo comm | grep -v grep | grep -c "^/Applications/Erebrus.app/Contents/MacOS/Erebrus$"`
}
...
#   Example: "/dev/disk3s1  Apple_HFS /Volumes/Erebrus-3.9.32 1" => "/Volumes/Erebrus-3.9.32 1"
...
_app_path_src="${_volume}/Erebrus.app"
